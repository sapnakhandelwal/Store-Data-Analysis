...
INSERT INTO `order_items` VALUES (1,1,4,4,3.74);
INSERT INTO `order_items` VALUES (2,2,1,2,9.10);
INSERT INTO `order_items` VALUES (3,2,4,4,1.66);
INSERT INTO `order_items` VALUES (4,2,6,2,2.94);
INSERT INTO `order_items` VALUES (5,3,3,10,9.12);
INSERT INTO `order_items` VALUES (6,4,3,7,6.99);
INSERT INTO `order_items` VALUES (7,4,10,7,6.40);
INSERT INTO `order_items` VALUES (8,5,2,3,9.89);
INSERT INTO `order_items` VALUES (9,6,1,4,8.65);
INSERT INTO `order_items` VALUES (10,6,2,4,3.28);
INSERT INTO `order_items` VALUES (11,6,3,4,7.46);
INSERT INTO `order_items` VALUES (12,6,5,1,3.45);
INSERT INTO `order_items` VALUES (13,7,3,7,9.17);
INSERT INTO `order_items` VALUES (14,8,5,2,6.94);
INSERT INTO `order_items` VALUES (15,8,8,2,8.59);
INSERT INTO `order_items` VALUES (16,9,6,5,7.28);
INSERT INTO `order_items` VALUES (17,10,1,10,6.01);
INSERT INTO `order_items` VALUES (18,10,9,9,4.28);
...
CREATE TABLE `order_item_notes` (
  ...
  PRIMARY KEY (`note_id`),
  KEY `fk_order_items_notes_orders_idx` (`order_id`),
  KEY `fk_order_items_notes_products_idx` (`product_id`),
  CONSTRAINT `fk_order_items_notes_orders` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_order_items_notes_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON UPDATE CASCADE)
  ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
